...
public class LogCollector {
	...
	private final String infoUrl  = "http://localhost:8083/info";
	private final String errorUrl = "http://localhost:8082/error";
	private final String warnUrl  = "http://localhost:8084/warn";
	private final String debugUrl = "http://localhost:8081/debug";
